...
/**
 * Blockchain configurations for USDT0 bridging via LayerZero.
 *
 * **IMPORTANT:** Selendra entries are placeholders. For USDT0 bridging to work on Selendra,
 * the following contracts must be deployed on-chain:
 * - OFT contract for USDT0
 * - LayerZero endpoint configuration
 * - TransactionValueHelper (for ERC-4337 support)
 *
 * These addresses can be injected via config once deployed.
 *
 * @constant {Object}
 */
export const BLOCKCHAINS = {
  ...
  // Placeholder entries for Selendra - contracts to be deployed
  selendra: {
    // Placeholder: Deploy USDT0 OFT contract on Selendra mainnet
    oftContract: null,
    // Placeholder: Deploy TransactionValueHelper for ERC-4337 support
    transactionValueHelper: null,
    // Placeholder: Assign LayerZero endpoint ID for Selendra
    eid: null,
    chainId: 1961
  },
  selendraTestnet: {
    // Placeholder: Deploy USDT0 OFT contract on Selendra testnet
    oftContract: null,
    // Placeholder: Deploy TransactionValueHelper for ERC-4337 support
    transactionValueHelper: null,
    // Placeholder: Assign LayerZero endpoint ID for Selendra testnet
    eid: null,
    chainId: 1953
  }
}
